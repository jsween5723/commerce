...
// 프로덕트 도메인과 연관 끊기
    ...
    companion object {
        fun from(orderedProductVO: ProductVO, order: Order) = OrderItem(
            order = order,
            productId = orderedProductVO.productId,
            name = orderedProductVO.name,
            priceOfOne = orderedProductVO.priceOfOne,
            quantity = orderedProductVO.quantity,
        )
    }
}